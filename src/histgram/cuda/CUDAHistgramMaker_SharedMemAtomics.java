...
public class CUDAHistgramMaker_SharedMemAtomics {
	CUfunction function;
	Pointer d_text;
	long textLength;
	Pointer d_histgram;
	...
	compile(CUmodule module, boolean generateDebugInfo) throws IOException {
	    ...
	    rc.setSourceFile("kernels/HistgramMakerKernel_SharedMemAtomics.cu");
		...
		cuModuleGetFunction(this.function, module, "histgramMakerKernel_SharedMemAtomics");
	}
